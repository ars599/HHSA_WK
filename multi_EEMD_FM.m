function [fm,am,FM,AM,IMF,IMF2,mx_nIMF2, ph, PH] = multi_EEMD_FM(data,fs,TNM,TNM2,S)
% This variation of multi_emd allows using different number of ensembles and noise level in the two level of eemd 
%[fm,am,FM,AM,IMF,IMF2,mx_nIMF2] = multi_AEEMD_FM(data,fs,TNM,TNM2,ifmethod,ifmethod2,NoiseLevel,NE,NoiseLevel2,NE2,ines,shiftLevel)
% Input
% data: 1D data
% fs: frequency ratem
% TNM: number of IMF;
...
maxC = 0;
for i_imf=1:CL
              IMF2(:,:,i_imf)=rcada_eemd_scn(fm(:,i_imf)', NoiseLevel2, NE2, TNM2, ines2,0); 
    cpoint2 =[];
    for j_imf = 1:TNM2
